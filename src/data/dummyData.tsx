...
const dummyData = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: "Movie ETL",
      description:
        "Movie ETL is a web application that extracts movie data from an external API, transforms it, and loads it into a database for easy access and analysis.",
      tags: [
        "Node.js",
        "React",
        "Typescript",
      ...
      gradient: "from-orange-400 to-rose-400",
      url: "https://movie-etl-frontend-2.vercel.app",
    },
    {
      image: resumeJobMatcher,
      title: "Resume Job Matcher",
      description:
        "This is a simple Java app that checks how well your resume fits a job description.",
    ...
    },
    {
      ...
      description:
        "Coffee shop management system with user authentication and authorization using JWT. (user, pass123)",
      tags: [
        "SpringBoot",
        "JWT",
        "Security",
    ...
    },
    {
      ...
      description:
        "Xyp service call client using fingerprint authentication. Built with C#.",
    ...
    },
    {
      ...
      description:
        "A serverless full-stack E-Commerce web app using React and Node.js, deployed entirely on AWS.",
    ...
    },
    {
      ...
      title: "Bakery Blog",
      description:
        "A blog management application where users can create, and interact with blog posts.",
    ...
    },
    {
      ...
      description:
        "A contact management application where users can create, and interact with contacts.",
      tags: ["React", "Typescript", "TailwindCSS", "Node.js", "Express"],
