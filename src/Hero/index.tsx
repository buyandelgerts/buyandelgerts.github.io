...
const Hero: React.FC<HeaderProps> = ({ handleScroll }) => (
  <section id="about" className="text-center py-20">
    <img
      src={profile}
      alt="My Profile"
      className="w-35 h-35 rounded-xl mx-auto mb-4 shadow-xl hover:scale-125"
    />
    ...
    <p className="max-w-2xl mx-auto text-gray-400 mb-8">
      I create robust and user-focused software solutions across backend and
      frontend technologies. Passionate about clean code, continuous learning,
      and leveraging cloud and AI tools to deliver innovation.
    </p>
    <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
      ...
      <a
        href="https://drive.google.com/file/d/1CO8gx37qHm0hNc-dG7zWBtdItxQdKjgu/view"
        target="_blank"
